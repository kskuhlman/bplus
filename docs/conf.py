...
latex_documents = [
    (master_doc, project_slug + '.tex', project + ' Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, project_slug, project + ' Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, project_slug, project + ' Documentation', author, project_slug,
